...
class SplitScriptValidationCollection {
    constructor() {
        ...
        this.validations.push(new RegexValidation_1.RegexValidation("Trailing white-space", "Trailing white space serves no purpose and should be removed.", CodeValidation_1.FunctionSeverity.error, /([ \t]+)$/gm, [], ["awk", "yaml"]));
        ...
        this.validations.push(new RegexValidation_1.RegexValidation("Empty BEGIN", "Empty BEGIN sections serves no purpose and should be disposed of.", CodeValidation_1.FunctionSeverity.warning, /(BEGIN {\s*})/g, [], ["awk"]));
        ...
        this.validations.push(new RegexValidation_1.RegexValidation("Empty END", "Empty END sections serves no purpose and should be disposed of.", CodeValidation_1.FunctionSeverity.warning, /(END {\s*})/g, [], ["awk"]));
        ...
        this.validations.push(new RegexValidation_1.RegexValidation("Tilde without space", "Tilde signs should be followed by space.\nExceptions to this are regexp.", CodeValidation_1.FunctionSeverity.error, /([^ \n]~[^ \n]|[^ \n]~|~[^ \n])/gm, [], ["awk"]));
